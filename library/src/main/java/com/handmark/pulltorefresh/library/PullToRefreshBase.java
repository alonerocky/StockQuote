...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected final void setHeaderScroll(int value) {
		...
		if (USE_HW_LAYERS) {
			 ...
			 */
			//public static final int LAYER_TYPE_NONE Added in API level 11
			//Constant Value: 0 (0x00000000)
			
			//public static final int LAYER_TYPE_SOFTWARE Added in API level 11
			//Constant Value: 1 (0x00000001)
			
			//public static final int LAYER_TYPE_HARDWARE Added in API level 11

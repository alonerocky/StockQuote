...
public class StockNewsFeedAdapter extends ArrayAdapter<HashMap<String,String>>
{
	private Context context;
	private ArrayList<HashMap<String, String>> lists;
	private int textViewResourceId ;
	public StockNewsFeedAdapter(Context context, int textViewResourceId,ArrayList<HashMap<String, String>> lists)	
	{
